...
//--------------- création des billes ---------------------------------
		...
		// Bille pilotée
		Bille billeLancePierreRose = new BillePilotée(/* new BillePesanteur(new Vecteur(0, 0.001), */ new BilleVoleuseDeTaille(new BilleFrottement(new BilleRebond(new BilleParDéfaut(p5, rayon * 6, Color.pink)))))/* ) */;
		billes.add(billeLancePierreRose);
		
		Bille billeLancePierreRose2 = new BillePilotée(/* new BillePesanteur(new Vecteur(0, 0.001), */ new BilleVoleuseDeTaille(new BilleFrottement(new BilleRebond(new BilleParDéfaut(p4, rayon / 2, Color.pink)))))/* ) */;
		billes.add(billeLancePierreRose2);
...
//-------------------- création de l'objet responsable de l'animation (c'est un thread séparé) -----------------------
		...
		app.addObserver((Observer) billeLancePierreRose2);
	}
