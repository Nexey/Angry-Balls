 ...
 * 
 */
public class BilleMvtPesanteurFrottementRebond extends BilleParDéfaut {
	Vecteur pesanteur;

	public BilleMvtPesanteurFrottementRebond(Vecteur position, double rayon, Vecteur vitesse, Vecteur pesanteur, Color couleur) {
